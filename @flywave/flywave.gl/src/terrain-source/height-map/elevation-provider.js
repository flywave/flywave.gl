...
class ElevationProvider { 
    ...
    getAtPoint(geoPoint: GeoCoordinates, defaultIfNotLoaded: ?number): number | null {
        ...
        const demTile = this.dataSource.dataProvider().getNeareastDemTile(TileKeyUtils.geoCoordinatesToTileKey(
            webMercatorTilingScheme, geoPoint, this.dataSource.dataProvider().getMaxZoom()));
    ...
    */
    ...
    getDisplacementMap(tileKey) { 
        ...
        if (!(tileDem && tileDem.displacementMap)) { return; }
