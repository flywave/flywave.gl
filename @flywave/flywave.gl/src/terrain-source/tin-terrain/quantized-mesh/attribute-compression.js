...
AttributeCompression.octEncodeInRange = function (vector, rangeMax, result) {
  ...
  var magSquared = vector.lengthSq();
...
var octEncodeScratch = new THREE.Vector2();
...
function fromSNorm(value, rangeMaximum) {
  rangeMaximum = defaultValue(rangeMaximum, 255);
  return (
    (THREE.MathUtils.clamp(value, 0.0, rangeMaximum) / rangeMaximum) * 2.0 - 1.0
  );
};
...
var scratchEncodeCart2 = new THREE.Vector2();
