...
import { fromVertices } from "../math/sphere";
...
var boundingSphereScratch = new THREE.Sphere();
...
export function upsampleQuantizedTerrainMesh(parameters, transferableObjects,
    ...
    var heights = parameters.heights;
    ...
    var parentTextureCoordAndEncodedNormals = parameters.textureCoordAndEncodedNormals;
    var position3DAndHeight = parameters.position3DAndHeight;
    ...
    for (i = 0, n = 0; i < quantizedVertexCount; ++i, n += 2) {
        ...
        if (hasVertexNormals) {
            ...
            if (encodedNormal.x > 128 || encodedNormal.y > 128) {
                console.log();
            }
        }
    ...
    for (i = 0; i < uBuffer.length; ++i) {
        ...
        cartesianVertices.push(position.x);
        cartesianVertices.push(position.y);
        cartesianVertices.push(position.z);
    }
    ...
    // const center = projection.unprojectPoint(boundingSphere.center);

    // boundingSphere.center = new THREE.Vector3(center.longitude, center.latitude, center.altitude);
    return {
...
var encodedScratch = new THREE.Vector2();
...
var depth = -1;
var cartesianScratch1 = [new THREE.Vector3(), new THREE.Vector3()];
var cartesianScratch2 = [new THREE.Vector3(), new THREE.Vector3()];
