...
children, theme, decoderUrl, enableControls = true, enableStatistics = false, decoderCount = 1, onMapInitialized, onMapDisposed, onResize, ...options }) {
    ...
    return (<MapProvider theme={theme} decoderUrl={decoderUrl} enableControls={enableControls} enableStatistics={enableStatistics} decoderCount={decoderCount} onMapInitialized={onMapInitialized} onMapDisposed={onMapDisposed} onResize={onResize} {...options}>
