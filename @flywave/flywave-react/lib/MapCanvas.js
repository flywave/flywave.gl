 ...
 * ```
 */
export function MapCanvas({ style = { width: "100%", height: "100%" }, className, onResize }) {
    const canvasRef = useRef(null);
    const containerRef = useRef(null);
    const { mapView, isLoading, error, canvasRef: providerCanvasRef, initializeMap, disposeMap } = useMapContext();
    ...
    return (_jsxs("div", { ref: containerRef, style: {
            ...
            overflow: "hidden",
            ...style
        }, className: className, children: [_jsx("canvas", { ref: canvasRef, style: {
                    display: "block",
                    width: "100%",
                    height: "100%"
                    ...
                    zIndex: 1000
                }, children: _jsx("div", { children: "\u6B63\u5728\u52A0\u8F7D\u5730\u56FE..." }) })), error && (_jsx("div", { style: {
                    position: "absolute",
                    top: 0,
                    left: 0,
                    right: 0,
                    ...
                    textAlign: "center",
                    zIndex: 1000
                }, children: _jsxs("div", { children: [_jsx("div", { style: { fontWeight: "bold", marginBottom: "10px" }, children: "\u5730\u56FE\u52A0\u8F7D\u5931\u8D25" }), _jsx("div", { style: { fontSize: "0.9em" }, children: error.message })] }) }))] }));
}
