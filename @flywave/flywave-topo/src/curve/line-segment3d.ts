...
import { CurveExtendOptions, VariantCurveExtendParameter } from "./curve-extend-mode";
import { CurveIntervalRole, CurveLocationDetail } from "./curve-location-detail";
import { AnnounceNumberNumberCurvePrimitive, CurvePrimitive } from "./curve-primitive";
...
export class LineSegment3d extends CurvePrimitive implements BeJSONFunctions {
    ...
    public override announceClipIntervals(
        ...
        return clipper.announceClippedSegmentIntervals(
            ...
            this._point1,
            announce
                ? (fraction0: number, fraction1: number) => announce(fraction0, fraction1, this)
                : undefined
        );
    }
