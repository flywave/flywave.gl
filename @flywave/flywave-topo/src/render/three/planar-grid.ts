...
import { Frustum, QPoint2dList, QPoint3dList } from "../../common";
import { Plane3dByOriginAndUnitNormal, Point2d, Transform } from "../../core-geometry";
import { GraphicBranch } from "../graphic-branch";
import { RenderGraphic } from "../render-graphic";
import { PlanarGridProps, RenderSystem } from "../render-system";
import { QBufferHandle2d, QBufferHandle3d } from "./attribute-buffers";
import { IndexedGeometry, IndexedGeometryParams } from "./cached-geometry";
...
class PlanarGridGeometryParams extends IndexedGeometryParams {
    ...
    public constructor(
        ...
        this.buffers["a_uvParam"] = uvParams;
...
export class PlanarGridGeometry extends IndexedGeometry {
    ...
    public static create(
        ...
        const indBuffer = new Uint32BufferAttribute(indices, 1);
