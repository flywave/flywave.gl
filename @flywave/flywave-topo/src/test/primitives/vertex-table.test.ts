...
import { Point2d, Point3d, Range3d } from "../../core-geometry";
import { ColorIndex, FeatureIndex, FeatureIndexType, FillFlags, QParams2d, QParams3d, QPoint3d, QPoint3dList, RenderTexture } from "../../common";
import { MockRender } from "../../render/mock-render";
import { Point3dList } from "../../common/render/primitives/mesh-primitive";
import { MeshArgs } from "../../primitives/mesh/mesh-primitives";
...
function expectMeshParams(args: MeshArgs, colorIndex: ColorIndex, vertexBytes: number[][], expectedColors?: number[], quvParams?: QParams2d) {
  const params = createMeshParams(args, renderSystem!.maxTextureSize);
