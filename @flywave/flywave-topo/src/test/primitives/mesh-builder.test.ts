...
import { Arc3d, AuxChannel, AuxChannelData, AuxChannelDataType, LineString3d, Loop, Point3d, PolyfaceAuxData, PolyfaceBuilder, Range3d, Transform } from "../../core-geometry";
...
import { Mesh } from "../../primitives/mesh/mesh-primitives";
import { PolyfacePrimitive, PolyfacePrimitiveList } from "../../primitives/polyface";
import { PrimitiveBuilder } from "../../primitives/geometry/geometry-list-builder";
import { StrokesPrimitiveList, StrokesPrimitivePointLists } from "../../primitives/strokes";
import { ToleranceRatio, Triangle } from "../../primitives/primitives";
import { MeshBuilder, MeshEdgeCreationOptions } from "../../primitives/mesh/mesh-builder";
...
describe("Mesh Builder Tests", () => {
  ...
  it("addStrokePointLists", () => {
    const primBuilder = new PrimitiveBuilder(renderSystem!, { type: GraphicType.Scene });
  ...
  describe("aux data", () => {
    function expectAuxChannelTable(mesh: Mesh, expectedUint16Data: number[]): void {
      ...
      const meshParams = createMeshParams(args, renderSystem!.maxTextureSize);
