...
import { IndexedPolyface, LineString3d, Loop, Path, Point3d, Range3d, Transform } from "../../core-geometry";
...
import { StrokesPrimitiveList, StrokesPrimitivePointList, StrokesPrimitivePointLists } from "../../primitives/strokes";
