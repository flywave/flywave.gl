...
import { ClipPrimitive } from "../../clipping/clip-primitive";
...
describe("ClipUtilities", () => {
    it("ClipPath", () => {
        ...
        const arc = Arc3d.createXY(
            Point3d.create(6, 0),
            8,
            AngleSweep.createStartEndDegrees(-141, 141)
        );
        ...
        it("ClipLoop1", () => {
            ...
            const lineSegment2 = LineSegment3d.create(
                Point3d.create(-10, 0),
                Point3d.create(-4, -5)
            );
            const lineString2 = LineString3d.create([
        ...
        it("ClipLoop2", () => {
            ...
            const lineSegment3 = LineSegment3d.create(
                Point3d.create(-6, -8),
                Point3d.create(6, -8)
            );
            const loop = Loop.create();
