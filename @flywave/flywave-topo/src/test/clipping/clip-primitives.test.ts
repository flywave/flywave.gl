...
import { ClipMaskXYZRangePlanes, ClipPrimitive, ClipShape } from "../../clipping/clip-primitive";
import { ClipUtilities } from "../../clipping/clip-utils";
import { ClipVector } from "../../clipping/clip-vector";
...
import { exerciseClipPrimitive } from "./clip-vector.test";
...
describe("ClipPrimitive", () => {
    ...
    it("ClipShapePointTests", () => {
        ...
        ck.testTrue(
            ClipShape.createShape(circlePoints, minZ, maxZ, undefined, true, true, clipShape0) !==
                undefined
        );
    ...
    it("ClipShape with simple concave area clips simple polygon", () => {
        ...
        const clippedPolygons = ClipUtilities.clipPolygonToClipShapeReturnGrowableXYZArrays(
            polygonA,
            clipShape
        );
    ...
    it("ClipVectorWithHole", () => {
        ...
        for (const range of [bigRange, rangeB]) {
            const rangeOfUndefinedClipper = ClipUtilities.rangeOfClipperIntersectionWithRange(
                undefined,
                range
            );
