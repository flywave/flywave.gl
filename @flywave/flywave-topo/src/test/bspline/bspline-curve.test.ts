...
import { BezierCurveBase } from "../../bspline/bezier-curve-base";
    ...
    it("BSplineCircleConversion", () => {
        ...
        const microstationStyleArc = {
            bcurve: {
                closed: true,
                knots: [
                    -0.33333333333333337, 0.0, 0.0, 0.0, 0.33333333333333331, 0.33333333333333331,
                    0.66666666666666663, 0.66666666666666663, 1.0, 1.0, 1.0, 1.3333333333333333
                ],
                order: 3,
                points: [
                    [1.0, 0.0, 0.0, 1.0],
            ...
            path: [
                {
                    bcurve: {
                        ...
                        knots: [
                            0, 0, 0, 0, 0.2500197756132385, 0.2500197756132385, 0.2500197756132385,
