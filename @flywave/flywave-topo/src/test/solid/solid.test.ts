...
describe("Solids", () => {
  ...
  it("Spheres", () => {
    ...
    ck.testUndefined(Sphere.createTopoSphere(origin, vectorX, vectorX, rA, rA, sweep, true));
    const northA = Sphere.createTopoSphere(origin, vectorX, vectorZ, rA, rA, northSweep, true)!;
    const northB = Sphere.createTopoSphere(origin, vectorX, vectorZ, rA, rA, northSweep, false)!;
