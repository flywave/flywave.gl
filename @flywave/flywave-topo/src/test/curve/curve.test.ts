...
import { CurveExtendMode } from "../../curve/curve-extend-mode";
import {
    CurveIntervalRole,
    CurveLocationDetail,
    CurveSearchStatus
...
describe("CurvePrimitive.TransitionSpiral", () => {
    it("CurvePrimitive.TransitionSpiral", () => {
        ...
        for (let i = 1; i <= numStroke; i++) {
            ...
            trapezoidSum +=
                (0.5 * (point0.direction.magnitude() + point1.direction.magnitude())) / numStroke;
...
describe("GeometryQuery", () => {
    ...
    it("CurvePrimitive", () => {
        const ck = new Checker();
        ck.testUndefined(
            CurveCollection.createCurveLocationDetailOnAnyCurvePrimitive(undefined, 0.5)
        );
        ck.testUndefined(
