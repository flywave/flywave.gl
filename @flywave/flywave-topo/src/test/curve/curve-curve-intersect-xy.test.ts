...
describe("CurveCurveIntersectXY", () => {
    ...
    it("IntersectXYWithTolerance", () => {
        ...
        if (
            ck.testExactNumber(1, intersectionsLoose.length, "found 1 intersection with loose tol")
        ) {
            ck.testTrue(
