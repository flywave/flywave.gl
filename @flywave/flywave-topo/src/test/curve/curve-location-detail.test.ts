...
describe("CurveLocationDetail", () => {
    ...
    it("CollapseToPoint", () => {
        ...
        ck.testExactNumber(
            copy.fraction,
            detail.fraction,
            "CurveLocationDetail.collapseToStart preserves fraction"
        );
        ck.testPoint3d(
            copy.point,
            detail.point,
            "CurveLocationDetail.collapseToStart preserves point"
        );
        ...
        ck.testExactNumber(
            copy.fraction,
            detail.fraction1!,
            "CurveLocationDetail.collapseToEnd moves fraction1 to fraction"
        );
        ck.testPoint3d(
            copy.point,
            detail.point1!,
            "CurveLocationDetail.collapseToEnd moves point1 to point"
        );
        if (
            ck.testUndefined(
                copy.fraction1,
                "CurveLocationDetail.collapseToEnd nullifies fraction1"
            ) &&
            ...
            ck.testExactNumber(
                copy1.fraction,
                copy.fraction,
                "CurveLocationDetail.collapseToEnd preserves fraction if fraction1 undefined"
            );
            ck.testPoint3d(
                copy1.point,
                copy.point,
                "CurveLocationDetail.collapseToEnd preserves point if point1 undefined"
            );
            ck.testUndefined(
                copy1.fraction1,
                "CurveLocationDetail.collapseToEnd preserves undefined fraction1"
            );
            ck.testUndefined(
                copy1.point1,
                "CurveLocationDetail.collapseToEnd preserves undefined point1"
            );
        }
        expect(ck.getNumErrors()).equals(0);
    });
