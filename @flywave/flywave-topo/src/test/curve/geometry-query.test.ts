...
describe("CylindricalRangeQuery", () => {
    ...
    it("StrokeCountChainCoverage", () => {
        ...
        ck.testFalse(
            StrokeCountSection.extendDistanceRangeBetweenStrokes(linestring, chain1, range)
        );
        ck.testFalse(
            StrokeCountSection.extendDistanceRangeBetweenStrokes(linestring, linestring0, range)
        );
        ck.testFalse(
            StrokeCountSection.extendDistanceRangeBetweenStrokes(chain1, linestring, range)
        );
