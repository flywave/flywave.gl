...
describe("CurveCurveIntersectXYZ", () => {
    ...
    it("LineStringLineStringCoplanar", () => {
        ...
        const intersectionsX = CurveCurve.intersectionXYZPairs(
            linestring0,
            true,
            linestring1,
            true
    ...
    it("LineLineStringCoplanar", () => {
        ...
        const numExpected = 2;
        testIntersectionsXYZ(ck, intersectionsX, numExpected, numExpected);
        const intersectionsX1 = CurveCurve.intersectionXYZPairs(
            lineString1,
            true,
            lineSegment0,
            true
    ...
    it("PathPath", () => {
        ...
        const lineSegment1 = LineSegment3d.create(
            Point3d.create(10, 3, 0),
            Point3d.create(1, 5, 0)
        );
