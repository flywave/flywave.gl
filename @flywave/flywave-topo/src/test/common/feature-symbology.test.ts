...
import { ColorDef } from "../../common/color-def";
import { BatchType, Feature } from "../../common/feature-table";
import { LinePixels } from "../../common/line-pixels";
import { RgbColor } from "../../common/rgb-color";
import { SubCategoryAppearance } from "../../common/sub-category-appearance";
import { SubCategoryOverride } from "../../common/sub-category-override";
import { Id64, Id64String } from "../../utils";
...
describe("FeatureOverrides", () => {
    ...
    it("subsumes by default", () => {
        ...
        expect(app.equals(FeatureAppearance.fromRgba(ColorDef.red.withTransparency(0x7f)))).to.be
            .true;
    });
});
...
describe("FeatureAppearanceProvider", () => {
    ...
    class Provider implements FeatureAppearanceProvider {
        public constructor(
            public readonly modifyAppearance: (app: FeatureAppearance) => FeatureAppearance
        ) {}
