...
import { PlaneByOriginAndVectors4d } from "../../geometry4d/plane-by-origin-and-vectors4d";
    ...
    it("ProjectiveLineIntersection", () => {
        ...
        for (const wA1 of [1, 1.1, 1.3]) {
            for (const wB0 of [1, 0.4, 2]) {
                hA1.w = wA1;
                hB0.w = wB0;
                const fractions = SmallSystem.lineSegment3dHXYTransverseIntersectionUnbounded(
                    hA0,
                    hA1,
                    hB0,
                    hB1
