...
import { GraphicBranch, GraphicBranchOptions } from "../../render/graphic-branch";
...
class System extends MockRender.System {
  ...
  public override createBatch(graphic: RenderGraphic, features: RenderFeatureTable, range: Range3d) {
