...
describe("AngleSweep", () => {
    it("Fractions", () => {
        ...
        source.testFractions(
            AngleSweep.createStartSweep(Angle.createRadians(0), Angle.createDegrees(360)),
            ck
        );
...
describe("SmallNumbers", () => {
    it("SmallNumbers", () => {
        ...
        for (let x = 1e-15; x < 0.001; x *= 10.0) {
            ck.testTrue(
                Geometry.isSmallMetricDistance(x) === Geometry.isSmallMetricDistanceSquared(x * x)
            );
        }
        expect(ck.getNumErrors()).equals(0);
    });
...
describe("Angle.fromJson", () => {
    it("Angle.fromJsonUndefined", () => {
        ...
        it("Angle.fromJsonUndefined", () => {
            ...
            assert.isOk(
                Angle.isAlmostEqualRadiansNoPeriodShift(output.startAngle.radians, startAngle)
            );
        ...
        it("Angle.fromJson", () => {
            ...
            assert.isOk(
                Angle.isAlmostEqualRadiansNoPeriodShift(output.endAngle.radians, endAngleInRadians)
            );
        }),
...
describe("Angle.create", () => {
    it("Angle.createClone", () => {
        ...
        it("Angle.createStartEnd", () => {
            ...
            assert.isOk(
                Angle.isAlmostEqualRadiansNoPeriodShift(result.endAngle.radians, endAngle.radians)
            );
        }),
        it("Angle.createStartSweepRadians", () => {
            ...
            assert.isOk(
                Angle.isAlmostEqualRadiansNoPeriodShift(result.startAngle.radians, startAngle)
            );
...
describe("Angle.cloneComplement", () => {
    it("Angle.cloneComplementReverseDirectionFalse", () => {
        ...
        assert.isOk(
            Angle.isAlmostEqualRadiansNoPeriodShift(output.startAngle.radians, startAngleComplement)
        );
        assert.isOk(
            Angle.isAlmostEqualRadiansNoPeriodShift(output.endAngle.radians, endAngleComplement)
        );
    }),
...
describe("Angle.radiansToPositivePeriodicFractionStartEnd", () => {
    it("Angle.10and(20,30)", () => {
        ...
        const outputFraction: number = AngleSweep.radiansToPositivePeriodicFractionStartEnd(
            radians,
            radians0,
            radians1
        );
