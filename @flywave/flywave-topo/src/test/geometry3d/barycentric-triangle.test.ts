...
describe("BarycentricTriangle", () => {
    ...
    it("BarycentricTriangle.ClosestPoint", () => {
        ...
        ck.testFalse(
            BarycentricTriangle.create(vertices[0], vertices[1], vertices[1]).pointToFraction(
                incenter
            ).isValid,
        ...
        const barycentricInsideOn: Array<[TriangleLocationDetail, boolean]> = [
...
describe("BarycentricTriangle.intersectRay3d", () => {
    it("BarycentricTriangle.intersectRay3d", () => {
        ...
        const rotatedTriangle = BarycentricTriangle.create(
            new Point3d(0, 0, 0),
            new Point3d(0, 0, 0),
            new Point3d(0, 0, 0)
        );
