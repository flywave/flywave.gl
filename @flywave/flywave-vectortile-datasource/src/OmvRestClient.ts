...
import { type ITransferManager, TransferManager } from "@flywave/flywave-transfer-manager";
...
export interface OmvRestClientParameters {
     ...
     *  - `{z}` - zoom level of tile, @see {@link @flywave/flywave-geoutils#TileKey.level}
     *  - `{x}` - horizontal coordinate of tile (column number),
     *            see {@link @flywave/flywave-geoutils#TileKey.column}
     *  - `{y}` - vertical coordinate of Tile (row number),
     *            see {@link @flywave/flywave-geoutils#TileKey.row}
     *
