...
import { type TileKey, EarthConstants, webMercatorTilingScheme } from "@flywave/flywave-geoutils";
import { type DataSourceOptions, DataSource, Tile } from "@flywave/flywave-mapview";
import {
    type DataProvider,
...
export interface VectorTileFactory {
    /** Create an instance of {@link @flywave/flywave-mapview#Tile} or a subclass. */
...
export interface VectorTileDataSourceParameters
    ...
    /**
     * Optional, custom factory for {@link @flywave/flywave-mapview#Tile} instances created
