...
class GLTFSplatController {
    ...
    initializeUI() {
        ...
        modelFolder
            .add(this.params, "modelUrl")
            .name("Model URL")
            .onChange((value: string) => {
                this.updateParams({ modelUrl: value });
            });
        modelFolder
            .add(this.params, "scale", 0.1, 10)
            .name("Scale")
            .onChange((value: number) => {
                this.updateParams({ scale: value });
            });
        modelFolder
            .add(this.params, "enableSplatting")
            .name("Enable Splatting")
        ...
        splatFolder
            .add(this.params, "pointSize", 0.1, 5)
            .name("Point Size")
            .onChange((value: number) => {
                // Update point size
        ...
        renderFolder
            .add(this.params, "castShadow")
            .name("Cast Shadow")
            .onChange((value: boolean) => {
                this.updateParams({ castShadow: value });
            });
        renderFolder
            .add(this.params, "receiveShadow")
            .name("Receive Shadow")
            .onChange((value: boolean) => {
        ...
        operationFolder
            .add({ info: () => console.log("Model Info:", this.getModelInfo()) }, "info")
            .name("Model Info");
