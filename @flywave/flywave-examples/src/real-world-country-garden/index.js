import { MapView, GeoCoordinates, MapControls, MapControlsUI, TileRenderDataSource, sphereProjection, DEMTerrainSource, ArcGISTileProvider, ModularMapViewMonitor, MapViewEventNames, GUI } from "@flywave/flywave.gl";
 ...
 * @param mapView Map view instance
 */
const add3DTileDataSources = (mapView) => {
