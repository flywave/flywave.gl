...
import { GeoCoordinates, TileKey, webMercatorTilingScheme } from "@flywave/flywave-geoutils";
import { MapControls, MapControlsUI } from "@flywave/flywave-map-controls";
import { CopyrightElementHandler, MapView, Tile } from "@flywave/flywave-mapview";
import {
    DataProvider,
    TileDataSource,
 ...
 * the styling capabilities of flywave.gl. If styling is not needed one could also
 ...
 *
 * The [[DataProvider]] is the component that is telling flywave.gl where to get the data from.
 ...
 * created by flywave.gl are loading the decoder bundle that
 ...
 * {@link https://github.com/heremaps/flywave.gl/blob/master/%40here/flywave-examples/decoder/decoder.ts|decoder.ts}
 * (Assuming you created your app with the
 * {@link https://github.com/heremaps/flywave.gl/blob/master/docs/GettingStartedGuide.md#yeoman|Yeoman generator}).
 *
