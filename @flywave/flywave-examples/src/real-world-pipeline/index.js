import { MapView, GeoCoordinates, MapControls, MapControlsUI, TileRenderDataSource, sphereProjection, DEMTerrainSource, ArcGISTileProvider, ModularMapViewMonitor, MapViewEventNames, GUI, GeoPolygon, TransferManager, FeaturesDataSource, } from "@flywave/flywave.gl";
 ...
 * @param mapView Map view instance
 */
const addPipeDataSources = (mapView) => {
 ...
 */
const addGroundOverlay = (demTerrain) => {
 ...
 * @param demTerrain DEM terrain data source
 */
const addGroundModification = (demTerrain) => {
 ...
 * @param mapView Map view instance
 */
const addGeoJsonDataSource = async (mapView) => {
    ...
    try {
        const json = await TransferManager.instance().downloadJson(PROJECT_CONFIG.REGION_DATA_PATH);
