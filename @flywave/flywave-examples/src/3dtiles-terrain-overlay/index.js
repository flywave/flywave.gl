import { MapView, GeoCoordinates, ellipsoidProjection, MapControls, CesiumIonDataSource, DEMTerrainSource, ArcGISTileProvider, MapControlsUI } from "@flywave/flywave.gl";
/**
 ...
 */
const createCesiumIonDataSource = (mapView) => {
