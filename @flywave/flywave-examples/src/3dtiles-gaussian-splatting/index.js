...
import { ArcGISWebTileDataSource, ellipsoidProjection, GeoCoordinates, MapControls, MapControlsUI, MapView, TileRenderDataSource } from "@flywave/flywave.gl";
/**
 ...
 */
const createGaussianSplatDataSource = (mapView) => {
 ...
 * @param mapView Map view instance
 */
const addArcGISWebTileDataSource = (mapView) => {
