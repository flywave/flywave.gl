...
import { CopyrightElementHandler, MapView, PickResult, Tile } from "@flywave/flywave-mapview";
import {
    DataProvider,
    TileDataSource,
...
/**
 * This example shows how to use the {@link @flywave/flywave-mapview#Tile.dependencies} property to ensure
 ...
 *
 * It combines part of the https://www.flywave.gl/docs/master/examples/#object-picking.html and
 * https://www.flywave.gl/docs/master/examples/#datasource_custom.html examples.
 * ```
 * {@link @flywave/flywave-mapview#Tile}s that contain the geometry from another Tile need to have a
 * reference to the Tile containing the overlapping geometry, this is achieved using the
 * `dependencies` property of the {@link @flywave/flywave-datasource-protocol#DecodedTile}
 * ```typescript
