...
import { MapView, GeoCoordinates, ellipsoidProjection, MapControls, MapControlsUI, DEMTerrainSource, GeoLineString, ArcGISTileProvider, } from "@flywave/flywave.gl";
 ...
 */
const defineModificationArea = () => {
    return new GeoLineString(CONFIG.MODIFICATION_LINE_COORDINATES, CONFIG.LINESTRING_HEIGHT);
};
/**
 ...
 */
const addTerrainModification = (heightMapSource, lineString) => {
 ...
 * @param lineString Terrain modification area
 */
const addGroundOverlay = (heightMapSource, lineString) => {
