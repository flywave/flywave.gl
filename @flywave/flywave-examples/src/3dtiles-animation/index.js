import { MapView, GeoCoordinates, ellipsoidProjection, MapControls, CesiumIonDataSource, MapControlsUI, WindowEventHandler } from "@flywave/flywave.gl";
 ...
 */
const initializeMapControls = (mapView) => {
 ...
 */
const create3DTilesDataSource = (mapView) => {
 ...
 */
const set3DTilesTheme = (dataSource) => {
 ...
 */
const setupMouseClickHandler = (mapView, dataSource, propertiesTable) => {
