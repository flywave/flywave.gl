...
export const getOutermostScreenPixelCoords = /*#__PURE__*/ FnVar((screenSize) => {
...
export const isValidScreenLocation = /*#__PURE__*/ FnVar((xy, screenSize) => {
    const eps = float(0.2);
...
export const transformSliceToUnit = /*#__PURE__*/ FnVar((sampleLocation, cameraZUnit, // -viewZ in unit space
camera) => (builder) => {
...
export const getCameraZUnit = /*#__PURE__*/ FnVar((camera, uv, viewZUnitNode // viewZ in unit space
) => (builder) => {
