...
import { instancedBufferAttribute, log, mix, pow, screenSize, uniform, vec3, vec4 } from "three/tsl";
import { PointsNodeMaterial } from "three/webgpu";
import { cameraFar, } from "../tsl/accessors";
...
const magnitudeToLuminance = /*#__PURE__*/ FnVar((magnitude, solidAngle) => {
...
export class StarsNodeMaterial extends PointsNodeMaterial {
    constructor() {
        super();
        this.pointSize = uniform(1);
        this.intensity = uniform(1000);
        this.magnitudeRange = [-2, 8];
        this.depthTest = true;
...
//# sourceMappingURL=StarsNodeMaterial.js.map