...
export function remap(x: number, min1: number, max1: number, min2: number, max2: number): number;
export function remap(x: number, min1: number, max1: number, min2 = 0, max2 = 1): number {
...
export function remapClamped(x: number, min1: number, max1: number, min2 = 0, max2 = 1): number {
