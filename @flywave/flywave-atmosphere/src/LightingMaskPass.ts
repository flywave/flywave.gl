...
import { depth } from "./shaders/core";

import { lightingMaskFragmentShader as fragmentShader } from "./shaders";
...
export class LightingMaskPass extends Pass {
    ...
    constructor(scene: Scene, camera: Camera) {
        ...
        (
            depthMaskMaterial as unknown as { copyCameraSettings: (camera: Camera) => void }
    ...
    override set mainCamera(value: Camera) {
        ...
        (
            this.depthMaskMaterial as unknown as { copyCameraSettings: (camera: Camera) => void }
        ).copyCameraSettings(value);
    }
