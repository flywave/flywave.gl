...
import { Float16Array, type TypedArray } from "./utils/typedArray";
import { parseFloat16Array } from "./utils/typedArrayParsers";
import { reinterpretType, type AnyFloatType } from "./utils/types";
import { isFloatLinearSupported } from "./utils/capabilities";

import { DataTextureLoader } from "./loaders/DataTextureLoader";
import { EXR3DTextureLoader } from "./loaders/EXR3DTextureLoader";
import { EXRTextureLoader } from "./loaders/EXRTextureLoader";
            ...
            return loader.load(
                ...
                texture => {
                    ...
                    if (
                        ...
                        (this.combinedScattering || textures.singleMieScatteringTexture != null) &&
