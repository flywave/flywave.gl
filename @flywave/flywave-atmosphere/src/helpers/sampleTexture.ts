...
import { HalfFloatType, Vector3, type TextureImageData, type Texture, type Vector2 } from "three";

import { clamp } from "../utils/math";
import { Float16Array, isTypedArray, type TypedArray } from "../utils/typedArray";
import { reinterpretType } from "../utils/types";

const vectorScratch1 = /*#__PURE__*/ new Vector3();
const vectorScratch2 = /*#__PURE__*/ new Vector3();
const vectorScratch3 = /*#__PURE__*/ new Vector3();

const float16ArrayCache = /*#__PURE__*/ new WeakMap<ArrayBufferLike, Float16Array>();
...
function getImageData(texture: Texture): TypedArray | undefined {
    ...
    reinterpretType<TextureImageData>(texture.image);
...
function samplePixel(data: TypedArray, index: number, result: Vector3): Vector3 {
    const dataIndex = index * 4; // Assume RGBA
    return result.set(data[dataIndex], data[dataIndex + 1], data[dataIndex + 2]);
}

export function sampleTexture(texture: Texture, uv: Vector2, result: Vector3): Vector3 {
