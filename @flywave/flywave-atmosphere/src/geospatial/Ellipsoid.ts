...
const projectVectorScratch = /*#__PURE__*/ new Vector3();
...
export function projectOnEllipsoidSurface(
    ...
    const intersection = projectVectorScratch.copy(position).multiplyScalar(ratio);
...
export class Ellipsoid {
    static readonly WGS84 = /*#__PURE__*/ new Ellipsoid(
        ...
        EarthConstants.EQUATORIAL_RADIUS,
        EarthConstants.EQUATORIAL_RADIUS * (1 - 1 / 298.257223563)
    );
