...
export function fromAstroVector(vector: Vector, result = new Vector3()): Vector3 {
    const { x, y, z } = vector;
    return result.set(x, y, z);
}

export function fromAstroRotationMatrix(matrix: RotationMatrix, result = new Matrix4()): Matrix4 {
