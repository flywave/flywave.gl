...
import { raySphereIntersection } from "./shaders/core";
...
import {
    skyFragmentShader as fragmentShader,
    skyShader as sky,
    skyVertexShader as vertexShader
} from "./shaders";
...
export class SkyMaterial extends AtmosphereMaterialBase {
    ...
    override onBeforeRender(
        ...
        const nextPerspectiveCamera = camera instanceof PerspectiveCamera;
