import { Ray, Vector3, Intersection, Raycaster } from "three";
...
export function raycastTraverseFirstHit(
    ...
    for (let i = 0, l = children.length; i < l; i++) {
        ...
        const boundingVolume = child.cached.boundingVolume.obb;
        if (boundingVolume.intersectsRay(localRay, _vec) !== null) {
