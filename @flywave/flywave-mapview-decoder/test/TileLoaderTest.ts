...
import { DecodedTile, Geometry, ITileDecoder, TileInfo } from "@flywave/flywave-datasource-protocol";
import {
    Projection,
    TileKey,
    TilingScheme,
...
describe("TileLoader", function () {
    ...
    describe("tile load", function () {
        ...
        // @flywave/flywave-mapview package, and trying to add package which contains the TileLoader
