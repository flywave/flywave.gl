...
export interface DecodedTile {
    ...
    /**
     * List of {@link @flywave/flywave-geoutils#TileKey}s stored as mortonCodes representing
     * {@link @flywave/flywave-mapview#Tile}s that have geometry covering this `Tile`.
     */
    dependencies?: number[];
}
