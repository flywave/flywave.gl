...
All the techniques are documented in the [`Techniques` class' source code](https://github.com/heremaps/flywave.gl/blob/master/%40here/flywave-datasource-protocol/lib/Techniques.ts).

To set a technique in a theme file, you can use a `technique` property. See examples below.

## How to Style a Map? - Overview of [flywave.gl](https://github.com/flywave.gl)'s Map Styling
...
An example theme file used in flywave-examples could be found in the
[berlin_tilezen_base.json](../flywave-map-theme/resources/berlin_tilezen_base.json).
...
For more in-depth details about the equality operators check the [@flywave/flywave-datasource-protocol/lib/Theme.ts](https://github.com/heremaps/flywave.gl/blob/master/%40here/flywave-datasource-protocol/lib/Theme.ts).
...
A list of possible style modifier for each techniques can be found in the [`Techniques` class' source code](https://github.com/heremaps/flywave.gl/blob/master/%40here/flywave-datasource-protocol/lib/Techniques.ts).
