import { Matrix4, Quaternion, Vector3, Spherical } from "three";
 ...
 * @returns The intersection parameter t (0 to 1) or -1 if no intersection
 */
export function rayCastToEllipsoid(
    ...
    const s = y * y + x * x + u * u - scaleX * scaleX;
