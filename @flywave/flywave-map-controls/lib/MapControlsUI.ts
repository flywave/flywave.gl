...
export class MapControlsUI {
    ...
    constructor(readonly controls: MapControls, options: MapControlsUIOptions = {}) {
        ...
        verticalAligner.className = "flywave-gl_v-align";
        ...
        this.m_buttonsElement.className = "flywave-gl_v-aligned";
        this.domElement.appendChild(this.m_buttonsElement);

        const zoomInButton = document.createElement("button");
        zoomInButton.innerText = "+";
        zoomInButton.className = "flywave-gl_controls_button-top";
        zoomInButton.classList.add("flywave-gl_controls-button");

        const zoomOutButton = document.createElement("button");
        zoomOutButton.innerText = "-";
        zoomOutButton.className = "flywave-gl_controls_button-bottom";
        zoomOutButton.classList.add("flywave-gl_controls-button");

        const tiltButton = document.createElement("button");
        tiltButton.innerText = "3D";
        tiltButton.id = "flywave-gl_controls_tilt-button-ui";
        tiltButton.title = "Toggle tilt";
        tiltButton.classList.add("flywave-gl_controls-button");
        tiltButton.classList.add("flywave-gl_controls_button-bottom");
        ...
        compassButton.classList.add("flywave-gl_controls-button");
        compassButton.classList.add("flywave-gl_controls_button-top");
        ...
        if (options.projectionSwitch) {
            ...
            switcher.classList.add("flywave-gl_controls-button");
...
function getTextStyle() {
    return `
        ...
        .flywave-gl_v-aligned{
            pointer-events: all;
            vertical-align: middle;
            display: inline-block;
        }
        .flywave-gl_controls-button {
            display: block;
        ...
        #flywave-gl_controls_tilt-button-ui {
            font-size: 16px;
        }
        .flywave-gl_controls-button:active {
            background-color: #37afaa;
            color: #eee;
        }
        .flywave-gl_controls-button:focus {
            outline:none;
        }
        .flywave-gl_controls_button-top{
            margin-bottom:0;
            border-bottom-right-radius:0;
            border-bottom-left-radius:0;
        }
        .flywave-gl_controls_button-bottom{
            margin-top:1px;
        ...
        #flywave-gl_controls-button_compass{
            overflow: hidden;
            margin: 5px 0 0 0;
        }
        ...
        .flywave-gl_controls_switch_svg{
            width: 25px;
            height: 25px;
            stroke: #d4d5d7;
            fill: #d4d5d7;
...
function getFlatMapSVG() {
    return `
    <svg style="margin-top:5px;" class="flywave-gl_controls_switch_svg" width="25" height="25" xmlns="http://www.w3.org/2000/svg" xmlns:svg="http://www.w3.org/2000/svg">
...
function getGlobeSVG() {
    return `
    <svg style="margin-top:5px;" stroke-width="2" class="flywave-gl_controls_switch_svg" width="50" height="50" viewBox="0 0 25 25" xmlns="http://www.w3.org/2000/svg" xmlns:svg="http://www.w3.org/2000/svg">
