...
class MapHillshadeMaterial extends THREE.ShaderMaterial {
    ...
    applyPaint() {
        ...
        this.uniforms.uHighlightColor.value.set((_c = p['hillshade-highlight-color']) !== null && _c !== void 0 ? _c : '#FFFFFF').convertLinearToSRGB();
        this.uniforms.uShadowColor.value.set((_d = p['hillshade-shadow-color']) !== null && _d !== void 0 ? _d : '#000000').convertLinearToSRGB();
        this.uniforms.uAccentColor.value.set((_e = p['hillshade-accent-color']) !== null && _e !== void 0 ? _e : '#000000').convertLinearToSRGB();
    }
    dispose() {
        super.dispose();
    }
