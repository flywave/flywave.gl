...
export type FilterSpecification = ExpressionSpecification | ['has', string] | ['!has', string] | ['==', string, string | number | boolean] | ['!=', string, string | number | boolean] | ['>', string, string | number | boolean] | ['>=', string, string | number | boolean] | ['<', string, string | number | boolean] | ['<=', string, string | number | boolean] | Array<string | FilterSpecification>;
...
export type SourceSpecification = VectorSourceSpec | RasterSourceSpec | RasterDEMSourceSpec | GeoJSONSourceSpec;
...
export type LayerSpecification = FillLayerSpec | LineLayerSpec | SymbolLayerSpec | CircleLayerSpec | FillExtrusionLayerSpec | BackgroundLayerSpec | RasterLayerSpec;
...
export declare const GEOMETRY_TYPE_MAP: Record<string, string[]>;
//# sourceMappingURL=MBStyleSpec.d.ts.map