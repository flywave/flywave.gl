...
/**
 * BrushShape - Defines available brush shapes for terrain modification
 * These control the shape of brush effect
 */
export type BrushShape = "circle" | "square" | "diamond" | "soft";
...
export interface BaseBrushSettings {
    radius: number; // Radius of brush in meters
    hardness: number; // Hardness of brush edge (0.0-1.0)
    shape?: BrushShape; // Shape of brush
}
...
/**
 * BrushOperation - Represents a single terrain modification operation
 *
 * Contains position information and brush settings for operation
 */
...
/**
 * Checks if provided settings are RaiseSettings
...
/**
 * Checks if provided settings are LowerSettings
 * @param settings - The brush settings to check
...
/**
 * Checks if provided settings are SmoothSettings
 * @param settings - The brush settings to check
...
/**
 * Checks if provided settings are FlattenSettings
 * @param settings - The brush settings to check
...
/**
 * Checks if provided settings are NoiseSettings
 * @param settings - The brush settings to check
...
/**
 * Checks if provided settings are ErodeSettings
 * @param settings - The brush settings to check
