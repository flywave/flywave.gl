import { DecoderOptions, WorkerDecoderProtocol } from "@flywave/flywave-datasource-protocol";
import { ConcurrentDecoderFacade, WorkerBasedDecoder } from "@flywave/flywave-mapview";

import { getOffScreenCanvas } from "../terrain/RenderHeightmap";

export class StratumWorkerBasedDecoder extends WorkerBasedDecoder {
