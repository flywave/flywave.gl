 ...
 */
export declare class HeightMapTileFactory extends TileFactory<TerrainResourceTile> {
    /**
     ...
     */
    create(dataSource: DEMTerrainSource, tileKey: TileKey): ShadowTerrainResourceTile;
}
