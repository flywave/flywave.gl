import { type TileAvailability, type TilingScheme } from "@flywave/flywave-geoutils";
import { type ElevationProvider as IElevationProvider, type ElevationRangeSource as IElevationRangeSource } from "@flywave/flywave-mapview";
...
import { type QuantizedProvider } from "./QuantizedTerrainProvider";
 ...
 */
export declare abstract class BaseQuantizedTerrainSource<QuantizedResource extends QuantizedTileResource> extends TerrainSource<QuantizedProvider<QuantizedResource>> {
    /**
     ...
     */
    protected abstract createProvider(options: BaseQuantizedTerrainSourceOptions): QuantizedProvider<QuantizedResource>;
    /**
     ...
     */
    constructor(quantizedileFactory: TileFactory<TerrainResourceTile>, options: BaseQuantizedTerrainSourceOptions);
    /**
     ...
     */
    setTilingScheme(value: TilingScheme): void;
    /**
