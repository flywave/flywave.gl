...
import { type ILayerStrategy, type LayerStrategyOptions } from "./layer-strategy/LayerStrategy";
 ...
 */
export declare abstract class QuantizedProvider<Resource extends QuantizedTileResource = QuantizedTileResource> extends ResourceProvider<Resource> {
    /**
     ...
     * @private
     */
    private readonly heightMapLevelSkipSize;
    /**
 ...
 */
export declare class QuantizedTerrainProvider extends QuantizedProvider<QuantizedTerrainMesh> {
    /**
     ...
     */
    getTile(tileKey: TileKey, abortSignal?: AbortSignal): Promise<QuantizedTerrainMesh | null>;
}
/**
 ...
 */
export declare class QuantizedStratumProvider extends QuantizedProvider<QuantizedStratumResource> {
    /**
     ...
     */
    getTile(tileKey: TileKey, abortSignal?: AbortSignal): Promise<QuantizedStratumResource | undefined>;
}
export {};
