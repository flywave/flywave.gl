...
export declare const FaceTypes: {
    ...
    readonly SideFace: number;
    readonly BoundaryFace: number;
    readonly GroundFace: number;
    readonly BedrockFace: number;
    readonly CutFace: number;
    readonly BoundarySideFace: number;
    readonly TopGroundFace: number;
    readonly BaseBedrockFace: number;
};
/**
