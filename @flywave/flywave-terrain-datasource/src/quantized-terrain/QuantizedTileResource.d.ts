import { BufferGeometry, type DataTexture } from "three";
 ...
 */
export declare abstract class QuantizedTileResource extends TileValidResource {
    /**
     ...
     */
    abstract get geometryProjection(): Projection;
    /**
     ...
     */
    protected abstract updateGeometryProjection(projection: Projection): any;
    /**
     ...
     */
    private m_reProjectGeometryPanding;
     ...
     */
    tryReprojectToProjection(targetProjection: Projection): Promise<void> | boolean;
    private m_RequestController;
    dispose(): void;
}
