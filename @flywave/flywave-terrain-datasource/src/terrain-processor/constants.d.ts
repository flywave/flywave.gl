 ...
 */
export declare const DEFAULT_RENDER_WIDTH = 256;
export declare const DEFAULT_RENDER_HEIGHT = 256;
/**
 ...
 */
export declare const HEIGHT_MAP_WIDTH = 256;
export declare const HEIGHT_MAP_HEIGHT = 256;
/**
 ...
 */
export declare const GROUND_MODIFICATION_WIDTH = 512;
export declare const GROUND_MODIFICATION_HEIGHT = 512;
