import { CopyrightInfo, TextureLoader, Tile, UrlCopyrightProvider } from "@flywave/flywave-mapview";
...
export class MapboxTileProvider implements WebTileDataProvider {
    /**
    ...
    constructor(private readonly m_options: MapboxWebTileDataSourceParameters) {
        this.m_style =
            m_options.style ||
