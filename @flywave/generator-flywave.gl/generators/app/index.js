...
module.exports = class extends Generator {
    ...
    install() {
        ...
        this.log(`Thanks for creating a flywave.gl app.
- tweet your accomplishment here: https://twitter.com/intent/tweet?text=flywave.gl
- flywave.gl tutorial: https://developer.here.com/tutorials/harpgl/
- extensive list of examples: https://www.flywave.gl/docs/master/examples/
