...
Yeoman generator for [flywave.gl](https://github.com/heremaps/flywave.gl) based projects.
...
mkdir 3dmap-example
cd 3dmap-example
npx -p yo -p @flywave/generator-flywave.gl yo @flywave/flywave.gl
...
```sh
mkdir ~/generator-flywave.gl-test #  create folder for test app
cd ~/generator-flywave.gl-test
```

Now you can check how your working copy of generator works, by running this after each change:

```sh
yo ~/src/flywave.gl/@flywave/generator-flywave.gl/generators/app/ # generate app
