 ...
 */
import { getTestResourceUrl, silenceLoggingAroundFunction } from "@flywave/flywave-test-utils";
...
describe("MapViewImageCache", function () {
    ...
    it("#addImage with url", function () {
        ...
        const imageUrl = getTestResourceUrl("@flywave/flywave-mapview", "test/resources/headshot.png");
...
describe("ImageCache", function () {
    ...
    if (typeof document !== "undefined") {
        ...
        image.src = getTestResourceUrl("@flywave/flywave-mapview", "test/resources/headshot.png");
