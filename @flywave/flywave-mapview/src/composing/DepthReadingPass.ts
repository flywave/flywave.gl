...
export class DepthReadingPass extends DepthCopyPass {
    ...
    setClassificationTypeFilter(classificationType: ClassificationType | 0): void {
        ...
        this.fullscreenMaterial.stencilFunc =
            classificationType === 0 ? THREE.AlwaysStencilFunc : THREE.EqualStencilFunc;
    }
    ...
    readDepth(ndc: THREE.Vector2 | THREE.Vector3): number | null {
        ...
        // DepthCopyPass.renderer is typed as WebGLRenderer by postprocessing v6.
        // readRenderTargetPixels is a synchronous WebGLRenderer API.
