 ...
 * can be defined in the {@link @flywave/flywave-datasource-protocol#Theme} sfile.
 */
export class PoiTableManager {
     ...
     * {@link @flywave/flywave-datasource-protocol#Theme}.
     *
     * @remarks
     * Note that duplicate names of {@link PoiTable}s in the
     * {@link @flywave/flywave-datasource-protocol#Theme} will lead to inaccessible {@link PoiTable}s.
     *
     * @param poiTables - {@link @flywave/flywave-datasource-protocol#PoiTableRef[]}
     *                containing all {@link PoiTable}s to load.
     *
     * @returns Resolved once all the {@link PoiTable}s in
     *          the {@link @flywave/flywave-datasource-protocol#Theme} have been loaded.
     */
     ...
     * are specified in the {@link @flywave/flywave-datasource-protocol#Theme}.
     *
     * @remarks
