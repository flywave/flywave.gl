...
/**
 * Interface for the {@link @flywave/flywave-datasource-protocol#ImageTexture}s
 ...
 * {@link @flywave/flywave-datasource-protocol#PoiGeometry} objects
 * from the {@link @flywave/flywave-datasource-protocol#DecodedTile},
...
export class PoiManager {
     ...
     *                      {@link @flywave/flywave-datasource-protocol#PoiGeometry}
     ...
     *
     * @remarks
     * Creates an {@link @flywave/flywave-datasource-protocol#ImageTexture}
    ...
    /**
     * Add an {@link @flywave/flywave-datasource-protocol#ImageTexture} such that it
     * is available as a named entity for techniques in theme files.
     *
     * @param imageTexture - {@link @flywave/flywave-datasource-protocol#ImageTexture}
    ...
    /**
     * Return the {@link @flywave/flywave-datasource-protocol#ImageTexture}
     * registered under the specified name.
     *
     * @param name - Name of the {@link @flywave/flywave-datasource-protocol#ImageTexture}.
     */
