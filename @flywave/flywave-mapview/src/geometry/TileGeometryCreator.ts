...
/**
 * Support class to create geometry for a {@link Tile} from a {@link @flywave/flywave-datasource-protocol#DecodedTile}.
 * @internal
 */
export class TileGeometryCreator {
     ...
     * @param decodedTile - The {@link @flywave/flywave-datasource-protocol#DecodedTile}.
     * @param textFilter -: Optional filter. Should return true for any text technique that is
     *      applicable.
     */
    createTextElements(
    ...
    /**
     * Gets the attachments of the given {@link @flywave/flywave-datasource-protocol#DecodedTile}.
     *
     * @param decodedTile - The {@link @flywave/flywave-datasource-protocol#DecodedTile}.
     */
