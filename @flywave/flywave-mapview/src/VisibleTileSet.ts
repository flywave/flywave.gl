...
import { assert, MathUtils, TaskQueue } from "@flywave/flywave-utils";
...
export class VisibleTileSet {
    ...
    /**
     * Dispose tiles that are marked for removal by {@link @flywave/flywave-lrucache#LRUCache} algorithm.
     */
    disposePendingTiles() {
