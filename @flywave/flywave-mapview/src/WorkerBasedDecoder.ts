...
export class WorkerBasedDecoder implements ITileDecoder {
     ...
     *
     * @remarks
     * Invokes {@link @flywave/flywave-datasource-protocol#DecodeTileRequest} on
    ...
    /**
     * Get {@link @flywave/flywave-datasource-protocol#TileInfo} from tile decoder service in worker.
     *
     * @remarks
     * Invokes {@link @flywave/flywave-datasource-protocol#TileInfoRequest}
     ...
     *
     * @remarks
     * Broadcasts {@link @flywave/flywave-datasource-protocol#ConfigurationMessage}
