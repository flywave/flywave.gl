...
import { type StylePriority } from "@flywave/flywave-datasource-protocol";
import {
    type GeoCoordinates,
    type Projection,
    type Vector3Like,
 ...
 * given {@link @flywave/flywave-geoutils#GeoCoordinates}.
 *
 * @remarkks
 * @example
 * Example:
...
export type MapAnchor<T extends THREE.Object3D = THREE.Object3D> = T & {
    /**
     * The position of this [[MapAnchor]] in {@link @flywave/flywave-geoutils#GeoCoordinates}.
     * @deprecated Use [[anchor]] instead.
     */
    geoPosition?: GeoCoordinates;

    /**
     * The anchor of this Object3D in {@link @flywave/flywave-geoutils#GeoCoordinates}
