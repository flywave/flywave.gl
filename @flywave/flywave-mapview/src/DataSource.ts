...
export abstract class DataSource extends THREE.EventDispatcher<{ update: {} }> {
    ...
    /**
     * The {@link @flywave/flywave-geoutils#Projection} used by
     * the {@link MapView} that is holding this `DataSource`.
     *
    ...
    /**
     * Returns the {@link @flywave/flywave-geoutils#TilingScheme} used by this `DataSource`.
     */
    ...
    /**
     * Apply the {@link @flywave/flywave-datasource-protocol#Theme} to this data source.
     *
     ...
     * {@link @flywave/flywave-geoutils#TileKey}.
     *
     ...
     * given {@link @flywave/flywave-geoutils#TileKey} and zoom level.
     *
     * @param zoomLevel - The zoom level of the {@link MapView}.
     * @param tileKey - The unique identifier for a map tile.
     * @returns `true` if the tile for the given {@link @flywave/flywave-geoutils#TileKey} can be loaded.
     */
     ...
     * further with given {@link @flywave/flywave-geoutils#TileKey} and
     * zoom level.
     *
     * @param zoomLevel - The zoom level of the {@link MapView}.
     * @param tileKey - The unique identifier for a map tile.
     * @returns `true` if the subtiles of the given {@link @flywave/flywave-geoutils#TileKey} should be
     ...
     * of the given {@link @flywave/flywave-geoutils#TileKey}.
     *
     * @param tileKey - The unique identifier for a map tile.
     * @returns `true` if the children of the given {@link @flywave/flywave-geoutils#TileKey} should be
     * checked for collisions.
     */
     ...
     * elements with the given {@link @flywave/flywave-geoutils#TileKey} and
     * zoom level.
     *
     * @remarks
     ...
     *          given {@link @flywave/flywave-geoutils#TileKey} should be rendered.
     */
