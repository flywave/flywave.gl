...
export interface MapViewOptions extends TextElementsRendererOptions, Partial<LookAtParams> {
    ...
    /**
     * The {@link @flywave/flywave-datasource-protocol#Theme} used by Mapview.
     *
     ...
     * ```
     *
     * @see {@link @flywave/flywave-utils#UriResolver}
     * @See {@link @flywave/flywave-utils#PrefixMapUriResolver}
     */
...
export interface LookAtParams {
     ...
     *
     * * if `bounds` is {@link @flywave/flywave-geoutils#GeoBox}, then `lookAt`
     *   use {@link LookAtParams.target} or `bounds.target` and
     *   ensure whole box is visible
     *
     * * if `bounds` is {@link @flywave/flywave-geoutils#GeoPolygon}, then `lookAt`
     *   use `bounds.getCentroid()` and ensure whole polygon is visible
     *
     * * if `bounds` is {@link @flywave/flywave-geoutils#GeoBoxExtentLike},
...
export class MapView extends EventDispatcher {
     ...
     *
     * @param projection - The {@link @flywave/flywave-geoutils#Projection} instance to use.
     */
     ...
     *  - if the tilt is high and projection is {@link @flywave/flywave-geoutils#sphereProjection}`
     ...
     * | ------               | ------      | --------
     * | {@link @flywave/flywave-geoutils#GeoBox}           | _defined_   | `params.target` is used
     * | {@link @flywave/flywave-geoutils#GeoBox}           | `undefined` | `bounds.center` is used as new `target`
     * | {@link @flywave/flywave-geoutils#GeoBoxExtentLike} | `undefined` | current `MapView.target` is used
     * | {@link @flywave/flywave-geoutils#GeoBoxExtentLike} | _defined_   | `params.target` is used
    ...
    /**
     * Moves the camera to the specified {@link @flywave/flywave-geoutils#GeoCoordinates},
     ...
     * in {@link @flywave/flywave-map-controls#MapControls}, where the center of
     ...
     *
     * @param pos - The position as a {@link @flywave/flywave-geoutils#GeoCoordLike} or
    ...
    /**
     * Returns the {@link @flywave/flywave-geoutils#GeoCoordinates} from the
