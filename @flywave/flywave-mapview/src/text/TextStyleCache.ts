 ...
 * {@link @flywave/flywave-datasource-protocol#Theme}'s TextStyle.
 */
...
export class TextStyleCache {
    ...
    /**
     * Retrieves a {@link TextElementStyle} for {@link @flywave/flywave-datasource-protocol#Theme}'s
     * [[TextStyle]] id.
     */
    ...
    /**
     * Gets the appropriate {@link @flywave/flywave-text-canvas#TextRenderStyle}
    ...
    /**
     * Create the appropriate {@link @flywave/flywave-text-canvas#TextLayoutStyle}
     * to use for a label. Depends heavily on the label's
     * [[Technique]] and the current zoomLevel.
     *
