import { Float16Array } from "./float16-stub";

function getFloat16(view: DataView, byteOffset: number, littleEndian?: boolean): number {
    const word = view.getUint16(byteOffset, littleEndian ?? true);
    const sign = (word >> 15) & 1;
    const exp = (word >> 10) & 0x1f;
    const mant = word & 0x3ff;
    if (exp === 0) {
...
export const parseUint8Array: TypedArrayParser<Uint8Array> = buffer => new Uint8Array(buffer);

export const parseInt8Array: TypedArrayParser<Int8Array> = buffer => new Int8Array(buffer);

export const parseUint16Array: TypedArrayParser<Uint16Array> = (buffer, littleEndian) =>
    parseTypedArray(buffer, Uint16Array, "getUint16", littleEndian);

export const parseInt16Array: TypedArrayParser<Int16Array> = (buffer, littleEndian) =>
    parseTypedArray(buffer, Int16Array, "getInt16", littleEndian);

export const parseInt32Array: TypedArrayParser<Int32Array> = (buffer, littleEndian) =>
    parseTypedArray(buffer, Int32Array, "getInt32", littleEndian);

export const parseUint32Array: TypedArrayParser<Uint32Array> = (buffer, littleEndian) =>
    parseTypedArray(buffer, Uint32Array, "getUint32", littleEndian);

export const parseFloat16Array: TypedArrayParser<Float16Array> = (buffer, littleEndian) =>
    parseTypedArray(buffer, Float16Array, "getFloat16", littleEndian);

export const parseFloat32Array: TypedArrayParser<Float32Array> = (buffer, littleEndian) =>
    parseTypedArray(buffer, Float32Array, "getFloat32", littleEndian);

export const parseFloat64Array: TypedArrayParser<Float64Array> = (buffer, littleEndian) =>
