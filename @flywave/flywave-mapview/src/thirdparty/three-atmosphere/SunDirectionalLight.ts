import { DirectionalLight, Matrix3, Matrix4, Vector3, type Texture } from "three";
...
export class SunDirectionalLight extends DirectionalLight {
    ...
    constructor(
        ...
        super();
        const {
            transmittanceTexture: transmittanceTextureParam = null,
            ellipsoid,
            correctAltitude,
            sunDirection,
            distance
        ...
        this.transmittanceTexture = transmittanceTextureParam;
