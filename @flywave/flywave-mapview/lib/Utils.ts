 ...
 * {@link @flywave/flywave-map-controls#MapControls} never matches
 * exactly the target due to the precision loss caused by the
 * conversion from zoom level to camera distance (done in
 * {@link (MapView.lookAt:WITH_PARAMS)} and {@link @flywave/flywave-map-controls#MapControls})
...
export namespace MapViewUtils {
    ...
    /**
     * Returns the {@link @flywave/flywave-geoutils#GeoCoordinates} of the camera,
     ...
     * @internal
     *
     * Return `GeoPoints` bounding {@link @flywave/flywave-geoutils#GeoBox}
     * applicable for {@link getFitBoundsDistance}.
     *
     * @returns {@link @flywave/flywave-geoutils#GeoCoordinates} set that covers `box`
     */
     ...
     * @param projection - The {@link @flywave/flywave-geoutils#Projection} used to
     ...
     *
     * @param projection - The {@link @flywave/flywave-geoutils#Projection} used when
    ...
    /**
     * @deprecated Use {@link @flywave/flywave-utils#DOMUtils.getBrowserLanguages}
     */
...
export namespace TileOffsetUtils {
    /**
     * @deprecated Use {@link @flywave/flywave-geoutils#TileKeyUtils.getKeyForTileKeyAndOffset}.
     */
    ...
    /**
     * @deprecated Use {@link @flywave/flywave-geoutils#TileKeyUtils.getParentKeyFromKey}.
     */
