...
export class BoxBuffer {
    /**
     * {@link @flywave/flywave-datasource-protocol#BufferAttribute} holding the `BoxBuffer` position data.
     */
    private m_positionAttribute?: THREE.BufferAttribute;

    /**
     * {@link @flywave/flywave-datasource-protocol#BufferAttribute} holding the `BoxBuffer` color data.
     */
    private m_colorAttribute?: THREE.BufferAttribute;

    /**
     * {@link @flywave/flywave-datasource-protocol#BufferAttribute} holding the `BoxBuffer` uv data.
     */
    private m_uvAttribute?: THREE.BufferAttribute;

    /**
     * {@link @flywave/flywave-datasource-protocol#BufferAttribute} holding the `BoxBuffer` index data.
     */
     ...
     * {@link @flywave/flywave-datasource-protocol#BufferAttribute}s.
     */
    ...
    /**
     * Creates a new {@link @flywave/flywave-datasource-protocol#Geometry} object
