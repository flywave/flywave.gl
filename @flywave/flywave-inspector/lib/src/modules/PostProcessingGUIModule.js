...
import { PostProcessingModule } from "./PostProcessingModule";
export class PostProcessingGUIModule {
    constructor(mapView, gui) {
        ...
        this.postProcessingModule = new PostProcessingModule(tempMonitor);
        this.gui = gui;
...
//# sourceMappingURL=PostProcessingGUIModule.js.map