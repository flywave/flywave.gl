...
import { EnhancedTileModule } from "../modules/EnhancedTileModule";
...
import { VisibleTileSetModule } from "../modules/VisibleTileSetModule";
...
export class ModularMapViewMonitor {
    ...
    getEnhancedTileFolder() {
        return this.enhancedTileFolder;
    }
    getVisibleTileSetFolder() {
    ...
    getPostProcessingFolder() {
        return this.postProcessingFolder;
    }
    getFogFolder() {
        return this.fogFolder;
    }
    getGroundModificationFolder() {
        return this.groundModificationFolder;
    }
}
//# sourceMappingURL=ModularMapViewMonitor.js.map