...
export class MapViewMonitor {
    constructor(mapView, parentGui) {
        this.folders = new Map();
        this.monitoredValues = new Map();
        ...
        this.updateCallbacks.push(() => {
            ...
            if (frameTimes.length > 0) {
                ...
                if (fpsValues.length > 0) {
                    fpsInfo.avgFps =
                        Math.round((fpsValues.reduce((a, b) => a + b, 0) /
                            fpsValues.length) *
                            100) / 100;
    ...
    setupMemoryInfo() {
        ...
        this.updateCallbacks.push(() => {
            if (window.performance && window.performance.memory) {
                ...
                memoryInfo.memoryUsage = Math.round((memoryInfo.usedJSHeapSize / memoryInfo.jsHeapSizeLimit) * 100);
            }
            else {
    ...
    setupTextInfo() {
        ...
        this.updateCallbacks.push(() => {
            ...
            if (textRenderer) {
                ...
                textInfo.renderedTextElements = textRenderer.renderedElementsCount || 0;
                textInfo.totalTextElements = textRenderer.totalElementsCount || 0;
                textInfo.fontCatalogs = textRenderer.fontCatalogsCount || 0;
                textInfo.loadingTextElements = textRenderer.loadingElementsCount || 0;
            }
        });
    }
    /**
    ...
    setupEnvironmentInfo() {
        ...
        this.updateCallbacks.push(() => {
            ...
            if (projection && typeof projection === "object" && projection.name) {
                envInfo.projection = projection.name;
            }
            else {
...
//# sourceMappingURL=MapViewMonitor.js.map