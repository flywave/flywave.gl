...
This module contains the themes used by `flywave.gl`.
...
The [style](resources/berlin_tilezen_base.json) is called `berlin`, inspired by the vibrant city of [Berlin](https://en.wikipedia.org/wiki/Berlin), where most of the development of `flywave.gl` is done.
