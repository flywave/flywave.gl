import type { GLTF, GLTFAccessor, GLTFBuffer, GLTFBufferView, GLTFImage, GLTFMaterial, GLTFMesh, GLTFNode, GLTFSampler, GLTFScene, GLTFSkin, GLTFTexture } from "../types/gltf-json-schema";
...
export declare class GLTFScenegraph {
    ...
    getObjectExtension<T = Extension>(object: Record<string, any>, extensionName: string): T | null;
