...
```bash
npm install --save @flywave/flywave-mapview @flywave/flywave-omv-datasource @flywave/flywave-map-theme @flywave/flywave-map-controls

```

You have installed 4 key components needed to render basic map:

-   `@flywave/flywave-mapview` - map renderer itself
-   `@flywave/flywave-map-controls` - map interaction like panning and tilting
-   `@flywave/flywave-omv-datasource` - tile provider based on OMV/MVT vector tile format
-   `@flywave/flywave-map-theme` - default theme and font resources required to render map in OMV/tilezen
    scheme
...
```shell
THREE=`npm view @flywave/flywave-mapview peerDependencies.three`
...
```typescript
  ngOnInit(): void {
    ...
    this.mapView = new MapView({
      canvas,
      theme:
        'https://unpkg.com/@flywave/flywave-map-theme/resources/berlin_tilezen_base.json',
    });
...
```typescript
import { OmvTileDecoderService, OmvTilerService } from "@flywave/flywave-omv-datasource/index-worker";
...
this.mapView = new MapView({
    canvas,
    theme: "https://unpkg.com/@flywave/flywave-map-theme/resources/berlin_tilezen_base.json",
...
@@ -1,5 +1,6 @@
 ...
 import { MapView } from '@flywave/flywave-mapview';
+import { OmvDataSource } from '@flywave/flywave-omv-datasource';
...
```bash
npm install --save @flywave/flywave-map-theme
```
...
+              {
+                "glob": "**/*",
+                "input": "./node_modules/@flywave/flywave-map-theme/resources",
+                "output": "./resources"
               }
             ],
             "styles": ["src/styles.css"],
...
```bash
npm install --save @flywave/flywave-map-controls
```
