...
function getExampleLink(exampleId) {
    // 获取当前语言前缀
...
function ExampleCard({ example }) {
    return (<div className={styles.exampleCard}>
            <div className={styles.exampleImage}>
                {example.image ? (<img src={example.image} alt={example.title} className={styles.exampleThumbnail}/>) : (<div className={styles.placeholderImage}>{example.title}</div>)}
            </div>
...
export default function Examples() {
    ...
    return (<Layout>
            ...
            return (<div key={category.code} className={`${styles.categorySection} slide-in-up`}>
            ...
            return (<div key={categoryCode} className={`${styles.categorySection} slide-in-up`}>
                                <Heading as="h2" className={styles.categoryTitle}>
                                    {categoryName}
                                </Heading>
                                <div className={styles.examplesGrid}>
