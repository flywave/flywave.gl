...
-   Each [TileObject] in each [Tile] needs to [backup the render order](https://github.com/heremaps/harp.gl/blob/0788d89/@flywave/flywave-mapview/lib/Tile.ts#L39), this is because during fallback, the objects [renderOrder] is adjusted based on what [levelOffset] it has, see how it is calculated [here](https://github.com/heremaps/harp.gl/blob/0788d89/@flywave/flywave-mapview/lib/MapView.ts#L3556). We need to reset it when the [Tile] is rendered normally (i.e. it isn't a fallback helper).
...
There are IBCT tests which are availabel internally in the @flywave/integration-tests repo, called `OmvMapRender`, the tests which check the fallback are called have `fallbackStyle: true` set, but this is unfortunately not public.
...
[leveloffset]: https://github.com/heremaps/harp.gl/blob/0788d89/@flywave/flywave-mapview/lib/Tile.ts#L253
[addgroundplane]: https://www.harp.gl/docs/master/doc/classes/harp_mapview.datasource-1.html#addgroundplane
[flywave-7856]: https://saeljira.it.here.com/browse/HARP-7856
