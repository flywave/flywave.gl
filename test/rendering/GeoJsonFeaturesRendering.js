...
const strokePolygonLayer = (params = {}) => {
    return {
        id: "stroke-polygon",
        styleSet: "geojson",
...
describe("GeoJson features", function () {
    ...
    describe("Stroke Arcs", async function () {
        const lineCaps = ["None", "Round", "Square", "TriangleIn", "TriangleOut"];
    ...
    describe("extruded-polygon technique", async function () {
        ...
        const isClockWise = (ring) => THREE.ShapeUtils.isClockWise(ring.map(p => new THREE.Vector2().fromArray(p)));
        ...
        it("Clockwise polygon with a hole", async function () {
            ...
            const outerRing = polygonWithHole.geometry.coordinates[0];
            const innerRing = polygonWithHole.geometry.coordinates[1];
        ...
        it("Clockwise multi-polygon with a hole wrong winding", async function () {
            ...
            const multi = turf.union(polygonWithHole, otherPolygonWithHole);
...
//# sourceMappingURL=GeoJsonFeaturesRendering.js.map