...
async function main() {
    ...
    const skipPackages: string[] = [
        "@flywave/create-harp.gl-app",
        "@flywave/generator-harp.gl",
        "@flywave/flywave-atlas-tools",
        "@flywave/flywave-test-utils",
        "@flywave/flywave-theme-tools",
        "@flywave/flywave-webpack-utils",
        "@flywave/harp.gl",
        "@flywave/flywave-website",
        "@flywave/flywave-performance-tests",
        "@flywave/flywave-rendering-test",
