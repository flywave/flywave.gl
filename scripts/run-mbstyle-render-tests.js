...
function main() {
    ...
    setTimeout(() => {
        ...
        const karmaClientArgs = [...filters.map((f) => `filter=${f}`), `feedback-url=http://localhost:${port}`,
            ...
            ...(process.env.MBSTYLE_ELEVCASTEROFF ? ["elevcasteroff=1"] : []),
            ...(process.env.MBSTYLE_STRUCTPOW ? [`structpow=${process.env.MBSTYLE_STRUCTPOW}`] : []),
            ...(process.env.MBSTYLE_OLDSUPP ? ["oldsupp=1"] : []),
            ...(process.env.MBSTYLE_G7OFF ? ["g7off=1"] : []),
            ...
            ...(process.env.MBSTYLE_MARKUPSTRUCTS === "1" ? ["markupstructs=1"] : []),
            ...(process.env.MBSTYLE_GLCATCH ? [`glcatch=${process.env.MBSTYLE_GLCATCH}`] : []),
            ...
            ...(process.env.MBSTYLE_PADDSKIP ? ["paddskip=1"] : []),
            ...(process.env.MBSTYLE_HSDBG ? [`hsdbg=${process.env.MBSTYLE_HSDBG}`] : []),
            ...(process.env.MBSTYLE_PXY ? [`pxy=${process.env.MBSTYLE_PXY}`] : []),
            ...(process.env.MBSTYLE_PXFROM ? [`pxfrom=${process.env.MBSTYLE_PXFROM}`] : []),
            ...
            ...(process.env.MBSTYLE_SHNOFF ? ["shnoff=1"] : []),
            ...(process.env.MBSTYLE_ORTHOSHADOWOFF ? ["orthoshadowoff=1"] : []),
            ...
            ...(process.env.MBSTYLE_DECODEERR ? ["decodeerr=1"] : []),
            ...(process.env.MBSTYLE_LODCMP ? ["lodcmp=1"] : []),
            ...(process.env.MBSTYLE_MLSWEEP ? [`mlsweep=${process.env.MBSTYLE_MLSWEEP}`] : []),
            ...(process.env.MBSTYLE_MLFORM ? [`mlform=${process.env.MBSTYLE_MLFORM}`] : []),
            ...(process.env.MBSTYLE_MLNORM ? [`mlnorm=${process.env.MBSTYLE_MLNORM}`] : []),
            ...(process.env.MBSTYLE_MLDIRAZ ? [`mldiraz=${process.env.MBSTYLE_MLDIRAZ}`] : []),
            ...(process.env.MBSTYLE_MLNDBG ? [`mndbg=${process.env.MBSTYLE_MLNDBG}`] : []),
            ...(process.env.MBSTYLE_WORLDADFOFF ? ["worldadf=0"] : []),
            ...(process.env.MBSTYLE_SHREPLON ? ["shrepl=1"] : [])];
