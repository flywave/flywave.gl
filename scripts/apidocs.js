 ...
 */
function fixAcornConflicts(content) {
    return (content
        // 转义花括号以避免 acorn 解析错误
        .replace(/{/g, "&#123;")
        .replace(/}/g, "&#125;")
 ...
 */
function processGeneratedMarkdownFiles() {
...
async function main() {
    ...
    // 生成文档
    console.log(execSync("pnpm exec api-documenter markdown --output-folder docs/docs/api ").toString());
    // 修复 acorn 解析错误
