...
All components can be used stand-alone and are in the `@flywave` subdirectory.
...
```sh
yarn add @flywave/flywave-mapview
```
...
In addition, please note that the [fonts](https://github.com/heremaps/flywave-fontcatalog) are under a different set of licenses.
